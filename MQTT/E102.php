	...
	while (true)
{
	...
	$bat=shell_exec('more /home/ndupont/Desktop/stockage_donnees/E102.txt | sed -n 5p | tr -d \'"\'');
	$room=shell_exec('more /home/ndupont/Desktop/stockage_donnees/E102.txt | sed -n 4p | tr -d \'"\'');
	$code=shell_exec('more /home/ndupont/Desktop/stockage_donnees/E102.txt | sed -n 3p | tr -d \'"\'');
	$nom=shell_exec('more /home/ndupont/Desktop/stockage_donnees/E102.txt | sed -n 2p | tr -d \'"\'');
    $valeur=shell_exec('more /home/ndupont/Desktop/stockage_donnees/E102.txt | sed -n 1p');
	$valeurMDP="passrt";
	$valeurLogin="batrt";
	$CodeBat="1";
