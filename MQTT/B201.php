...
<?php
	...
	$bat=shell_exec('more /home/ndupont/Desktop/stockage_donnees/B201.txt | sed -n 5p | tr -d \'"\''); //recovery and line filtering of data stored in the file
	$room=shell_exec('more /home/ndupont/Desktop/stockage_donnees/B201.txt | sed -n 4p | tr -d \'"\''); //recovery and line filtering of data stored in the file
	$code=shell_exec('more /home/ndupont/Desktop/stockage_donnees/B201.txt | sed -n 3p | tr -d \'"\''); //recovery and line filtering of data stored in the file
	$nom=shell_exec('more /home/ndupont/Desktop/stockage_donnees/B201.txt | sed -n 2p | tr -d \'"\''); //recovery and line filtering of data stored in the file
        $valeur=shell_exec('more /home/ndupont/Desktop/stockage_donnees/B201.txt | sed -n 1p'); //recovery and line filtering of data stored in the file
	$valeurMDP="passgim";
	$valeurLogin="batgim";
	$CodeBat="2";
